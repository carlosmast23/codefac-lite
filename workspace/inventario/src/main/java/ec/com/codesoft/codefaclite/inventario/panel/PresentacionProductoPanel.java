 ...
 * @author Carlos
 */
public abstract class PresentacionProductoPanel extends ControladorCodefacInterface {

    /**
     * Creates new form CategoriaPanel
     */
    public PresentacionProductoPanel() {
        initComponents();
    }
    ...
    /*@TexT(value = "controlador.presentacion.descripcion")
    ...
    //@LimpiarAnotacion
    @TextFieldBinding(value = "controlador.presentacion.nombre")
    ...
    @TextFieldBinding(value = "controlador.presentacion.descripcion")
