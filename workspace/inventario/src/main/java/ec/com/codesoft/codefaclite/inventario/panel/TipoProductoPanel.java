 ...
 * @author Carlos
 */
public abstract class TipoProductoPanel extends ControladorCodefacInterface {

    /**
     * Creates new form CategoriaPanel
     */
    public TipoProductoPanel() {
        initComponents();
    }
    ...
    //@LimpiarAnotacion
    @TextFieldBinding(value = "controlador.tipoProducto.nombre")
    ...
    @TextFieldBinding(value = "controlador.tipoProducto.descripcion")
