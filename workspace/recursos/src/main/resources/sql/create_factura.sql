...
(
    ...
    IRBPNR decimal(13,2),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.6.0,MOSTRAR_ERROR=NO)*/
    ...
    NOTA varchar(256), 
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.9.1)*/
    ORDEN_NUMERO INTEGER,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.0.2)*/
    VALOR_RECIBIDO decimal(13,2),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.1.7)*/
    OBSERVACION varchar(512),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.2.9)*/
    DESCUENTO_IVA_ADICIONAL decimal(13,2),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.4.0.1)*/
    PORCENTAJE_VENDEDOR BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.4.0.1)*/
    PORCENTAJE_REFERIDOS BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.4.0.1)*/
    ORIGEN_VENTA_ID BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.4.0.1)*/
...
(
    ...
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.3.0)*/
...
(
    ID BIGINT not null GENERATED ALWAYS AS IDENTITY (START WITH 1),
    IMPUESTO_ID BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.5.8)*/
