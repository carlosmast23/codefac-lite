...
(
    ...
    AHORRO decimal(13,2),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.2.3)*/
    TIPO_IDENTIFICACION_CODIGO_SRI varchar(3),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.5.5)*/
    IRBPNR decimal(13,2),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.6.1,MOSTRAR_ERROR=NO)*/
    ...
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.3.8)*/
...
(
    ...
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.3.1)*/
