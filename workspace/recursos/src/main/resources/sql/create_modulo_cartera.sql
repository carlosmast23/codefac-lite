...
create table CARTERA( 
    ...
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.0.5)*/
    NUMERO_CUOTA INT,  
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.1.1)*/
    SRI_FORMA_PAGO_ID BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.1.7)*/
    DESCRIPCION varchar(128),
    CONSTRAINT id_forma_pago_fk FOREIGN KEY (SRI_FORMA_PAGO_ID) REFERENCES SRI_FORMA_PAGO(ID),
    primary key (ID)
);
