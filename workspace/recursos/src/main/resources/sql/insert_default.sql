...
INSERT INTO SRI_IDENTIFICACION (CODIGO,TIPO_IDENTIFICACION_LETRA, TIPO_TRANSACCION,TIPO_IDENTIFICACION,FECHA_INICIO)
    VALUES ('01','R', 'COMPRA', 'RUC','2000-01-01');

INSERT INTO SRI_IDENTIFICACION (CODIGO,TIPO_IDENTIFICACION_LETRA, TIPO_TRANSACCION,TIPO_IDENTIFICACION,FECHA_INICIO)
    VALUES ('02','C', 'COMPRA', 'CEDULA','2000-01-01');

INSERT INTO SRI_IDENTIFICACION (CODIGO,TIPO_IDENTIFICACION_LETRA, TIPO_TRANSACCION,TIPO_IDENTIFICACION,FECHA_INICIO)
    VALUES ('03','P', 'COMPRA', 'PASAPORTE / IDENTIFICACION TRIBUTARIA DEL EXTERIOR','2000-01-01');

INSERT INTO SRI_IDENTIFICACION (CODIGO,TIPO_IDENTIFICACION_LETRA, TIPO_TRANSACCION,TIPO_IDENTIFICACION,FECHA_INICIO)
    VALUES ('04','R', 'VENTA', 'RUC','2000-01-01');

INSERT INTO SRI_IDENTIFICACION (CODIGO,TIPO_IDENTIFICACION_LETRA, TIPO_TRANSACCION,TIPO_IDENTIFICACION,FECHA_INICIO)
    VALUES ('05','C', 'VENTA', 'CEDULA','2000-01-01');

INSERT INTO SRI_IDENTIFICACION (CODIGO,TIPO_IDENTIFICACION_LETRA, TIPO_TRANSACCION,TIPO_IDENTIFICACION,FECHA_INICIO)
    VALUES ('06','P', 'VENTA', 'PASAPORTE / IDENTIFICACION TRIBUTARIA DEL EXTERIOR','2000-01-01');

INSERT INTO SRI_IDENTIFICACION (CODIGO,TIPO_IDENTIFICACION_LETRA, TIPO_TRANSACCION,TIPO_IDENTIFICACION,FECHA_INICIO)
    VALUES ('07','F', 'VENTA', 'CONSUMIDOR FINAL','2000-01-01');

INSERT INTO SRI_IDENTIFICACION (CODIGO,TIPO_IDENTIFICACION_LETRA, TIPO_TRANSACCION,TIPO_IDENTIFICACION,FECHA_INICIO)
    VALUES ('19','O', 'VENTA', 'PLACA o RAMV/CPN ','2000-01-01');
...
INSERT INTO SRI_RETENCION_IVA (RETENCION_ID,NOMBRE, CODIGO_SRI,PORCENTAJE,DESCRIPCION,FECHA_INICIO)
    VALUES (2,'NO APLICA' , '0' ,0,'NO APLICA','2000-01-01'),
           (2,'10%' , '9' ,10,'','2000-01-01'),
           (2,'20%' , '10',20,'','2000-01-01'),
           (2,'30%' , '1' ,30,'','2000-01-01'),
           (2,'50%' , '11',50,'','2000-01-01'),
           (2,'70%' , '2' ,70,'','2000-01-01'),
           (2,'100%', '3' ,100,'','2000-01-01'),
           (2,'0%'  , '7' ,0,'Retencion en 0%','2000-01-01'),
           (2,'0%'  , '8' ,0,'Retencion en 12%','2000-01-01');


INSERT INTO SRI_RETENCION_RENTA (RETENCION_ID,CODIGO_SRI, NOMBRE,PORCENTAJE,DESCRIPCION,FECHA_INICIO)
    VALUES (1,'520','Pago al exterior - Otros conceptos de ingresos gravados',22,'','2000-01-01'),
           (1,'333','CONVENIO DE DÉBITO O RECAUDACIÓN',0,'','2000-01-01'),
           (1,'334','PAGO CON TARJETA DE CRÉDITO',1,'','2000-01-01');
...
insert into SRI_RETENCION_RENTA (RETENCION_ID, CODIGO_SRI, NOMBRE, PORCENTAJE, FECHA_INICIO, FECHA_FIN) values(1,'343','EMPRENDEDORES',1.0000,'2013-01-01 00:00:00',NULL);
...
INSERT INTO COMPONENTE_COMPROBANTE_FISICO (BANDA_COMPROBANTE_ID,NOMBRE,UUID,X,Y,ANCHO,ALTO,TAMANIO_LETRA,NEGRITA,OCULTO)
    VALUES
          ...
          (1,'codigoCliente','69c5392e-b14b-4951-9c27-0e2f077f0a0f',289,5,133,15,10,'n','s'),
          (1,'numeroOrden','c8fe5904-016e-4bfd-823c-a215d0fb94d8',18,65,133,15,10,'n','s'),
          (1,'ciudad','9c03d4c5-858a-4a6d-9fc5-23c46cfdc718',289,20,133,15,10,'n','s'),
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('ArabiaSaudita','SAUDI','SAU');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Bangladés','BANGLADESI','BGD');
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Barbados','BARBADENSE','BRB');
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Baréin','BAREINI','BHR');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Catar','CATARI','QAT');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('EmiratosArabesUnidos','EMIRATI','ARE');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Etiopía','ETIOPE','ETH');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Irak','IRAQUI','IRQ');
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Irán','IRANI','IRN');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Israel','ISRAELI','ISR');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Kuwait','KUWAITI','KWT');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Malaui','MALAUI','MWI');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Marruecos','MARROQUI','MAR');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Nepal','NEPALI','NPL');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Omán','OMANI','OMN');
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('PaísesBajos','NEERLANDÉSA','NLD');
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Pakistán','PAKISTANI','PAK');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('ReinoUnido','BRITANICA','GBR');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Somalia','SOMALI','SOM');
...
INSERT INTO NACIONALIDAD(PAIS_NAC,GENTILICIO_NAC,ISO_NAC)VALUES('Yemen','YEMENI','YEM');
