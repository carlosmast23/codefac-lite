...
INSERT INTO ESTUDIANTE (REPRESENTANTE1_ID, NACIONALIDAD_ID, CODAUXILIAR, CEDULA, EMAIL, NOMBRES, APELLIDOS, GENERO, FECHA_NACIMIENTO, TELEFONO, CELULAR, DIRECCION, ADICIONALES, ETNIA, DISCAPACIDAD, CONADIS, TIPO_DISCAPACIDAD, OBS_DISCAPACIDAD, PORCENTAJE_DISCAPACIDAD, ESTADO) 
	VALUES (NULL, 53, 'P001', '1758007734', '', 'THOMAS ANDRES', 'PROAÑO PILLAJO', 'M', '2017-03-25', '', '', NULL, NULL, NULL, 'n', '', 'n', NULL, NULL, 'A');
INSERT INTO ESTUDIANTE (REPRESENTANTE1_ID, NACIONALIDAD_ID, CODAUXILIAR, CEDULA, EMAIL, NOMBRES, APELLIDOS, GENERO, FECHA_NACIMIENTO, TELEFONO, CELULAR, DIRECCION, ADICIONALES, ETNIA, DISCAPACIDAD, CONADIS, TIPO_DISCAPACIDAD, OBS_DISCAPACIDAD, PORCENTAJE_DISCAPACIDAD, ESTADO) 
	VALUES (NULL, 53, 'P002', '', '', 'LUCIANA', 'DIAZ ALDANA', 'F', '2016-03-08', '', '', NULL, NULL, NULL, 'n', '', 'n', NULL, NULL, 'A');
INSERT INTO ESTUDIANTE (REPRESENTANTE1_ID, NACIONALIDAD_ID, CODAUXILIAR, CEDULA, EMAIL, NOMBRES, APELLIDOS, GENERO, FECHA_NACIMIENTO, TELEFONO, CELULAR, DIRECCION, ADICIONALES, ETNIA, DISCAPACIDAD, CONADIS, TIPO_DISCAPACIDAD, OBS_DISCAPACIDAD, PORCENTAJE_DISCAPACIDAD, ESTADO) 
	VALUES (NULL, 53, 'P003', '1756947535', '', 'SABRINA ANAHI', 'LOPEZ ORTIZ', 'F', '2015-07-30', '', '', NULL, NULL, NULL, 'n', '', 'n', NULL, NULL, 'A');
INSERT INTO ESTUDIANTE (REPRESENTANTE1_ID, NACIONALIDAD_ID, CODAUXILIAR, CEDULA, EMAIL, NOMBRES, APELLIDOS, GENERO, FECHA_NACIMIENTO, TELEFONO, CELULAR, DIRECCION, ADICIONALES, ETNIA, DISCAPACIDAD, CONADIS, TIPO_DISCAPACIDAD, OBS_DISCAPACIDAD, PORCENTAJE_DISCAPACIDAD, ESTADO) 
	VALUES (NULL, 53, 'P004', '', '', 'SOFIA DANIELA', 'RISUEÑO INFANTE', 'F', '2014-05-26', '', '', NULL, NULL, NULL, 'n', '', 'n', NULL, NULL, 'A');
INSERT INTO ESTUDIANTE (REPRESENTANTE1_ID, NACIONALIDAD_ID, CODAUXILIAR, CEDULA, EMAIL, NOMBRES, APELLIDOS, GENERO, FECHA_NACIMIENTO, TELEFONO, CELULAR, DIRECCION, ADICIONALES, ETNIA, DISCAPACIDAD, CONADIS, TIPO_DISCAPACIDAD, OBS_DISCAPACIDAD, PORCENTAJE_DISCAPACIDAD, ESTADO) 
	VALUES (NULL, 53, 'P005', '1728303080', '', 'ELIAN ALEJANDRO', 'MAYORGA BAYAS', 'M', '2013-08-22', '', '', NULL, NULL, NULL, 'n', '', 'n', NULL, NULL, 'A');
INSERT INTO ESTUDIANTE (REPRESENTANTE1_ID, NACIONALIDAD_ID, CODAUXILIAR, CEDULA, EMAIL, NOMBRES, APELLIDOS, GENERO, FECHA_NACIMIENTO, TELEFONO, CELULAR, DIRECCION, ADICIONALES, ETNIA, DISCAPACIDAD, CONADIS, TIPO_DISCAPACIDAD, OBS_DISCAPACIDAD, PORCENTAJE_DISCAPACIDAD, ESTADO) 
