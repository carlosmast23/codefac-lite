...
INSERT INTO CLIENTE (NOMBRES, APELLIDOS, TIPO_OPERADOR, RAZON_SOCIAL, NOMBRE_LEGAL, TIPO_IDENTIFICACION, IDENTIFICACION, TIPO_CLIENTE, DIRECCION, TELEFONO_CONVENCIONAL, EXTENSION_TELEFONO, TELEFONO_CELULAR, CORREO_ELECTRONICO, ACTIVIDAD_COMERCIAL, ESTADO,SRI_FORMA_PAGO_ID) 
VALUES 
('Carlos', 'Perez', 'C', 'Carlos Perez', NULL, '04', '1719468108001', 'CLIENTE', 'Sangolqui', '022087044', '0', '0983528439', 'jcp_computer@hotmail.com', NULL, 'A',1),
('Juan', 'Loya', 'C', 'JUAN Loya', NULL, '04', '1724218951001', 'CLIENTE', 'Conocoto', '022087065', '0', '0983528439', 'juancarlos100pl@hotmail.com', NULL, 'A',1)
;
...
INSERT INTO CATALOGO_PRODUCTO (CATEGORIA_ID,MODULO_COD, TIPO_COD, NOMBRE, DESCRIPCION, IVA_ID, ICE_ID, IRBPNR_ID) 
	VALUES (2,'INVS', 'MA', 'Matriculas', NULL, 2, NULL, NULL);
INSERT INTO CATALOGO_PRODUCTO (CATEGORIA_ID,MODULO_COD, TIPO_COD, NOMBRE, DESCRIPCION, IVA_ID, ICE_ID, IRBPNR_ID) 
	VALUES (2,'INVS', 'NA', 'pensiones', NULL, 2, NULL, NULL);
INSERT INTO CATALOGO_PRODUCTO (CATEGORIA_ID,MODULO_COD, TIPO_COD, NOMBRE, DESCRIPCION, IVA_ID, ICE_ID, IRBPNR_ID) 
	VALUES (2,'INVS', 'NA', 'suplementarias', NULL, 2, NULL, NULL);
