...
(
    ...
    USUARIO_ID BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.9.9)*/
    KILOMETRAJE BIGINT,
    primary key(ID)
);
...
(
    ...
    PLACA varchar(64),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.4.0.1)*/
    PORCENTAJE_VENDEDOR BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.4.0.1)*/
    PORCENTAJE_REFERIDOS BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.4.0.1)*/
    PORCENTAJE_COLABORADOR BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.4.0.4)*/
    ALIAS varchar(25),    
    primary key(ID)
);
...
(
    ...
    TERMINADO varchar(1),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.7.9)*/
    USUARIO_ID BIGINT,
...
( 
    ...
    USUARIO_ULTIMA_EDICION_ID BIGINT,  
    ESTADO varchar(1),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.6.4)*/
    TALLER_NOMBRE varchar(100),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.6.8)*/
    PRIORIDAD BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.7.5)*/
    TIPO_DANIO BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.6.8)*/
    TALLER_ID BIGINT,
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.8.3)*/
    DIAS_ESTIMADOS INT,
...
/*@AGREGAR_TABLA(VERSION_SISTEMA=1.3.0.6.4)*/
create table TALLER
(
    ID BIGINT not null GENERATED ALWAYS AS IDENTITY (START WITH 1), 
    NOMBRE varchar(100),
...
(
    ...
    ESTADO varchar(1),
    primary key (ID),
    CONSTRAINT id_taller_fk FOREIGN KEY (TALLER_ID) REFERENCES TALLER(ID),
    CONSTRAINT id_taller_mantenimiento_fk FOREIGN KEY (TAREA_MANTENIMIENTO_ID) REFERENCES TAREA_MANTENIMIENTO(ID)
...
( 
    ...
    CONSTRAINT id_taller_tarea_fk FOREIGN KEY (TALLER_TAREA_ID) REFERENCES TALLER_TAREA(ID)
);
...
/*@AGREGAR_TABLA(VERSION_SISTEMA=1.3.0.8.1)*/
create table MANTENIMIENTO_INFORME_DETALLE
(
    ID BIGINT not null GENERATED ALWAYS AS IDENTITY (START WITH 1), 
    CODIGO_TIPO_NO_CONFORMIDAD varchar(12), 
    PARTE_VEHICULO varchar(128),
    MANTENIMIENTO_TAREA_DETALLE_ID BIGINT,
    primary key (ID)
);