...
/*@AGREGAR_SCRIPT (VERSION_SISTEMA=1.2.8.5.5,MOSTRAR_ERROR=NO)*/
ALTER TABLE CAJA_SESSION DROP COLUMN ARQUEO_CAJA_ID ;
/*@AGREGAR_SCRIPT (VERSION_SISTEMA=1.2.8.5.5,MOSTRAR_ERROR=NO)*/
ALTER TABLE ARQUEO_CAJA ADD COLUMN CAJA_SESSION_ID BIGINT;
/*@AGREGAR_SCRIPT (VERSION_SISTEMA=1.2.8.5.5,MOSTRAR_ERROR=NO)*/
ALTER TABLE INGRESO_CAJA ADD COLUMN VALOR decimal(13,2);
/*@AGREGAR_SCRIPT (VERSION_SISTEMA=1.2.8.5.5,MOSTRAR_ERROR=NO)*/
ALTER TABLE ARQUEO_CAJA ADD COLUMN USUARIO_ID BIGINT;
/*@AGREGAR_SCRIPT (VERSION_SISTEMA=1.2.8.5.5,MOSTRAR_ERROR=SI)*/
ALTER TABLE INGRESO_CAJA DROP COLUMN VENTA_ID ;
/*@AGREGAR_SCRIPT (VERSION_SISTEMA=1.2.8.5.5,MOSTRAR_ERROR=SI)*/
ALTER TABLE INGRESO_CAJA ADD COLUMN FACTURA_ID BIGINT;