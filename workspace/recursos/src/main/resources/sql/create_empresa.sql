...
(
    ...
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.2.1)*/
    LOGO_IMAGEN_PEQUENIO_PATH varchar(512),
...
(
    ...
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.2.8.1.1)*/
    CODIGO varchar(3),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.2.9.5.6)*/
...
(
    ...
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.2.8)*/
