...
(
  ...
  /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.2.9.7.1,MOSTRAR_ERROR=NO)*/
    ...
    COD_PRESENTACION_DEFECTO_VENTA varchar(50),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.4.4)*/
    COD_PRESENTACION_DEFECTO_COMPRA varchar(50),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.0.6.7)*/
    PSICOTROPICO varchar(2),
    /*@AGREGAR_COLUMNA(VERSION_SISTEMA=1.3.1.0.1)*/
    RESPONSABLE_REQUERIDO varchar(1),
...
/*@AGREGAR_TABLA(VERSION_SISTEMA=1.3.0.9.2)*/
...
(
    ...
    ESTADO varchar(1),
    primary key(ID),
    CONSTRAINT COMPONENTE_PRODUCTO_FK FOREIGN KEY (PRODUCTO_ID) REFERENCES PRODUCTO(ID_PRODUCTO)
);

/*@AGREGAR_TABLA(VERSION_SISTEMA=1.3.0.9.3)*/
create table PRODUCTO_COMPONENTE_DETALLE
(
    ID BIGINT not null GENERATED ALWAYS AS IDENTITY( START WITH 1),
    PRODUCTO_ID BIGINT,  
    PRODUCTO_COMPONENTE_ID BIGINT,  
    primary key(ID),
    CONSTRAINT COMPONENTE_PRODUCTO_FK2 FOREIGN KEY (PRODUCTO_ID) REFERENCES PRODUCTO(ID_PRODUCTO),
    CONSTRAINT COMPONENTE_PRODUCTO_FK3 FOREIGN KEY (PRODUCTO_COMPONENTE_ID) REFERENCES PRODUCTO_COMPONENTE(ID)
);