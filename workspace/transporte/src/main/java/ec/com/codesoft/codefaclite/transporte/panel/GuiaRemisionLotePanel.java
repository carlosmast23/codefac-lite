 ...
 */
public abstract class GuiaRemisionLotePanel extends ControladorCodefacInterface {

    /**
     * Creates new form GuiaRemisionLotePanel
     */
    public GuiaRemisionLotePanel() {
        initComponents();
    }
    ...
    @TextFieldBinding(value = "controlador.motivoTraslado")
    public JTextField getTxtMotivoTraslado() {
        return txtMotivoTraslado;
    }

    public void setTxtMotivoTraslado(JTextField txtMotivoTraslado) {
        this.txtMotivoTraslado = txtMotivoTraslado;
    }
