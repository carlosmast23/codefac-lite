...
public class RutaService extends ServiceAbstract<Ruta,RutaFacade> implements RutaServiceIf{
    ...
    public Ruta consultarRutaActivaPorVendedorYCliente(Empleado vendedor,PersonaEstablecimiento clienteOficina) throws ServicioCodefacException, RemoteException
    {
        List<Ruta> resultado=getFacade().consultarRutaActivaPorVendedorYClienteFacade(vendedor, clienteOficina);
        if(resultado.size()>0)
        {
