 ...
 */
public enum CategoriaProductoEnumEstado {
      /**
    ...
    private CategoriaProductoEnumEstado(String estado) {
        this.estado = estado;
    }
    ...
    public static CategoriaProductoEnumEstado getEnum(String estado) {
        for (CategoriaProductoEnumEstado enumerador : CategoriaProductoEnumEstado.values()) {
