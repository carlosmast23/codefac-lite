...
import ec.com.codesoft.codefaclite.servidor.service.ObjetoMantenimientoService;
...
import ec.com.codesoft.codefaclite.servidor.service.ProductoComponenteService;
...
public abstract class ControllerServiceUtil {
    ...
    public static void cargarRecursosServidor(String host) {
        try {
            ...
            mapRecursos.put(ProductoComponenteService.class,ProductoComponenteServiceIf.class);
