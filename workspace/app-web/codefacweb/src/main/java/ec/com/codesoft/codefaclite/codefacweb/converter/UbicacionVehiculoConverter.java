 ...
 * @author Carlos
 */
@FacesConverter("ubicacionVehiculoConverter")
public class UbicacionVehiculoConverter extends AbstractConverter implements Converter {

    @Override
    public Object buscarObjetoPorId(String valor) throws RemoteException {
        //System.out.println("Valor Converter:"+valor);
        return Mantenimiento.UbicacionEnum.getEnum(valor);
