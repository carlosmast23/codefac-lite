 ...
 */
@FacesConverter("tipoNoConformidadConverter")
public class TipoNoConformidadConverter extends AbstractConverter implements Converter  {

    @Override
    public Object buscarObjetoPorId(String valor) throws RemoteException {
        return TipoNoConformidadEnum.buscarPorCodigo(valor);
    }
