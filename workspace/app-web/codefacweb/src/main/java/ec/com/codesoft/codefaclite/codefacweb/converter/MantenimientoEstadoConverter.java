 ...
 * @author Carlos
 */
@FacesConverter("mantenimientoEstadoConverter")
public class MantenimientoEstadoConverter extends AbstractConverter implements Converter{

    @Override
    public Object buscarObjetoPorId(String id) throws RemoteException {
        return Mantenimiento.MantenimientoEnum.getEnum(id);
    }
