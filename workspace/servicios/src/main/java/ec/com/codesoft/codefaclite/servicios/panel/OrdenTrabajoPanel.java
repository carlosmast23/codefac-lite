...
public abstract class OrdenTrabajoPanel extends ControladorCodefacInterface{
    ...
    private void initComponents() {
        ...
        btnCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/iconos/pequenos/Zoom.png"))); // NOI18N
        ...
        btnBuscarVehiculo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/iconos/pequenos/Zoom.png"))); // NOI18N
        btnBuscarVehiculo.setToolTipText("Agregar Cliente");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        getContentPane().add(btnBuscarVehiculo, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        getContentPane().add(spnKilometraje, gridBagConstraints);
    ...
    public void setSpnKilometraje(JSpinner spnKilometraje) {
        this.spnKilometraje = spnKilometraje;
    }
