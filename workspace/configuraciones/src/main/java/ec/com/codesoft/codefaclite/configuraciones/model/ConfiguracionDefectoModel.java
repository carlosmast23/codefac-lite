...
//    @Override
    ...
    private void iniciarVariables() {
        ...
        UtilidadesComboBox.llenarComboBox(getCmbRecalcularEditarPrecioEmpaque(),EnumSiNo.values());
        ...
        UtilidadesComboBox.llenarComboBox(getCmbAdvertenciaUtilidadNegativa(),EnumSiNo.values());
        UtilidadesComboBox.llenarComboBox(getCmbAgregarDetalleInicio(),EnumSiNo.values());
    ...
    private void cargarDatos() {
        try {
            ...
            ParametroCodefac parametroMostrarCostosFacturar = parametrosTodos.get(ParametroCodefac.MOSTRAR_COSTOS_FACTURAR);
            ...
            ParametroCodefac parametroTmp = parametrosTodos.get(ParametroCodefac.AGREGAR_PRODUCTO_DIRECTO_LECTOR_BARRAS);
            ...
            parametroTmp = parametrosTodos.get(ParametroCodefac.ADVERTENCIA_UTILIDAD_NEGATIVA);
            enumSiNo = EnumSiNo.getEnumByLetra((parametroTmp != null) ? parametroTmp.getValor() : null);
            getCmbAdvertenciaUtilidadNegativa().setSelectedItem((enumSiNo!=null)?enumSiNo:null);
            
            parametroTmp = parametrosTodos.get(ParametroCodefac.AGREGAR_DETALLE_INICIO);
            enumSiNo = EnumSiNo.getEnumByLetra((parametroTmp != null) ? parametroTmp.getValor() : null);
            getCmbAgregarDetalleInicio().setSelectedItem((enumSiNo!=null)?enumSiNo:null);
            ...
            ParametroCodefac parametroMostrarPreciosConIva = parametrosTodos.get(ParametroCodefac.MOSTRAR_PRECIO_CON_IVA);
            ...
            ParametroCodefac editarRecalcularPrecioPorcentaje = parametrosTodos.get(ParametroCodefac.RECALCULA_EDITAR_PRECIO_EMPAQUE);
            enumSiNo = EnumSiNo.getEnumByLetra((editarRecalcularPrecioPorcentaje != null) ? editarRecalcularPrecioPorcentaje.getValor() : null);
            getCmbRecalcularEditarPrecioEmpaque().setSelectedItem((enumSiNo != null) ? enumSiNo : null);
    ...
    private void setearVariable() {
        ...
        agregarParametroEditar(ParametroCodefac.AGREGAR_PVP_ANTERIOR);
        ...
        enumSiNo = (EnumSiNo) getCmbAdvertenciaUtilidadNegativa().getSelectedItem();
        agregarParametro(ParametroCodefac.ADVERTENCIA_UTILIDAD_NEGATIVA, (enumSiNo != null) ? enumSiNo.getLetra() : null);
        agregarParametroEditar(ParametroCodefac.ADVERTENCIA_UTILIDAD_NEGATIVA);
        
        enumSiNo = (EnumSiNo) getCmbAgregarDetalleInicio().getSelectedItem();
        agregarParametro(ParametroCodefac.AGREGAR_DETALLE_INICIO, (enumSiNo != null) ? enumSiNo.getLetra() : null);
        agregarParametroEditar(ParametroCodefac.AGREGAR_DETALLE_INICIO);
        ...
        enumSiNo = (EnumSiNo) getCmbRecalcularEditarPrecioEmpaque().getSelectedItem();
        agregarParametro(ParametroCodefac.RECALCULA_EDITAR_PRECIO_EMPAQUE, (enumSiNo != null) ? enumSiNo.getLetra() : null);
        agregarParametroEditar(ParametroCodefac.RECALCULA_EDITAR_PRECIO_EMPAQUE);
