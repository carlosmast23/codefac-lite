...
public class TestEncriptar {
    public static void main(String[] args) {
        try {
            ...
            String datosSinEncriptar=UtilidadesEncriptar.desencriptar("$2a$12$meSmp.deopaRI9UYSHdoIu4lYDa40cTKipNqR/Wjdeq4L93.jTmpm", ParametrosSistemaCodefac.LLAVE_ENCRIPTAR);
