...
public class TestEncriptar {
    public static void main(String[] args) {
        try {
            ...
            //String datosSinEncriptar=UtilidadesEncriptar.desencriptar("3PFlcSg+plmfKHDOQbq9Dg==", ParametrosSistemaCodefac.LLAVE_ENCRIPTAR);
            
            String datosSinEncriptar=UtilidadesEncriptar.encriptar("2023-03-15", ParametrosSistemaCodefac.LLAVE_ENCRIPTAR); 
