 ...
 */
public class TipoEstablecimientoBusqueda implements InterfaceModelFind<TipoEstablecimiento> {

    private Empresa empresa;

    public TipoEstablecimientoBusqueda(Empresa empresa) {
    ...
    public QueryDialog getConsulta(String filter,Map<Integer,Object> mapFiltro) {
        String queryString=" SELECT u FROM TipoEstablecimiento u where u.estado=?1 and u.empresa=?2 and u.nombre like ?3 ";
    ...
    @Override
    public void agregarObjeto(TipoEstablecimiento t, Vector dato) {
