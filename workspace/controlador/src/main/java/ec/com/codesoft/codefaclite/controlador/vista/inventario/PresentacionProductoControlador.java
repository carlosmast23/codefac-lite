...
import ec.com.codesoft.codefaclite.controlador.aplicacion.dialog.busqueda.PresentacionProductoDialogo;
 ...
 */
public class PresentacionProductoControlador extends ModelControladorAbstract<PresentacionProductoControlador.CommonIf,PresentacionProductoControlador.SwingIf,PresentacionProductoControlador.WebIf> implements VistaCodefacIf {

    private PresentacionProducto presentacion;
    
    public PresentacionProductoControlador(MensajeVistaInterface mensajeVista, SessionCodefacInterface session, CommonIf interfaz, TipoVista tipoVista) {
    ...
    public void editar() throws ExcepcionCodefacLite, RemoteException {
        try {
            setearDatosAdicionales();
            ServiceFactory.getFactory().getPresentacionProductoServiceIf().editar(presentacion);
    ...
    public void eliminar() throws ExcepcionCodefacLite, RemoteException {
        ...
        {
            try {
                ServiceFactory.getFactory().getPresentacionProductoServiceIf().eliminar(presentacion);
    ...
    public InterfaceModelFind obtenerDialogoBusqueda() {
        return new PresentacionProductoDialogo(session.getEmpresa());
    }

    @Override
    public void cargarDatosPantalla(Object entidad) {
        presentacion=(PresentacionProducto) entidad;
    }
    ...
    {
        presentacion.setEmpresa(session.getEmpresa());
    }
