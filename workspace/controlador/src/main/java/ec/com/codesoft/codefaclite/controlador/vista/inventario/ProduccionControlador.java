 ...
 * @author DellWin10
 */
public class ProduccionControlador extends ModelControladorAbstract<ProduccionControlador.CommonIf, ProduccionControlador.SwingIf, ProduccionControlador.WebIf> implements VistaCodefacIf{
    ...
    public void iniciar() throws ExcepcionCodefacLite, RemoteException {
        try {
            bodegaList=ServiceFactory.getFactory().getBodegaServiceIf().obtenerActivosPorEmpresa(session.getEmpresa());
            
            
        } catch (ServicioCodefacException ex) {
            Logger.getLogger(ProduccionControlador.class.getName()).log(Level.SEVERE, null, ex);
        }
