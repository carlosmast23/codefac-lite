 ...
 * @author DellWin10
 */
public class TipoProductoBusqueda implements InterfaceModelFind<TipoProducto>{
    
    private Empresa empresa;
    
    public TipoProductoBusqueda(Empresa empresa) {
    ...
    public QueryDialog getConsulta(String filter,Map<Integer,Object> mapFiltro) {
        String queryString=" SELECT u FROM TipoProducto u where u.estado=?1 and u.empresa=?2 and u.nombre like ?3 ";
    ...
    @Override
    public void agregarObjeto(TipoProducto t, Vector dato) {
