 ...
 */
public class CasaComercialDialogo implements InterfaceModelFind<CasaComercial>{
    
    private Empresa empresa;

    public CasaComercialDialogo(Empresa empresa) {
    ...
    public QueryDialog getConsulta(String filter,Map<Integer,Object> mapFiltro) {
        String queryString=" SELECT u FROM CasaComercial u where u.estado=?1 and u.empresa=?2 and ( u.nombre like ?3) ";
    ...
    @Override
    public void agregarObjeto(CasaComercial t, Vector dato) {
        dato.add(t.getId());
