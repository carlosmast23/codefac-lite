...
public enum BodegaEnumEstado {
    ...
    private BodegaEnumEstado(String estado) {
        this.estado = estado;
    }
    ...
    public static BodegaEnumEstado getEnum(String estado) {
        for (BodegaEnumEstado enumerador : BodegaEnumEstado.values()) {
