...
public class ProductoPrecioDataTable implements Serializable {
    ...
    public static Long idGeneral = 1l;
    ...
    public int hashCode() {
        int hash = 3;
        hash = 31 * hash + Objects.hashCode(this.idTmp);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ProductoPrecioDataTable other = (ProductoPrecioDataTable) obj;
        if (!Objects.equals(this.idTmp, other.idTmp)) {
            return false;
        }
        return true;
    }
