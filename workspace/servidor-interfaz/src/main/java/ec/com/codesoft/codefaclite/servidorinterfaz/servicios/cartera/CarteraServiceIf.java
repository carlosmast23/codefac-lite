...
public interface  CarteraServiceIf extends ServiceAbstractIf<Cartera>{
    ...
    public void eliminarCrucesPorCartera(Cartera carteraPadre,Boolean afectarCaja,EntityManager entityManager) throws ServicioCodefacException, RemoteException;
