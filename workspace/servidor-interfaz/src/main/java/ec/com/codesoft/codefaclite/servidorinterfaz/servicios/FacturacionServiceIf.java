...
public interface FacturacionServiceIf extends ServiceAbstractIf<Factura>
{
    ...
    public List<Factura> obtenerFacturasReporte(Persona persona,Date fi,Date ff,String estado,Boolean consultarReferidos,Persona referido) throws java.rmi.RemoteException;
