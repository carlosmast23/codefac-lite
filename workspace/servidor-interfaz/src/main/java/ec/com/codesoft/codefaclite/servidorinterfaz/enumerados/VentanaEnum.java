...
public enum VentanaEnum implements Serializable{
    ...
    COMANDA("ec.com.codesoft.codefaclite.facturacion.model.ProformaModel", "COMD", "Comanda", ModuloCodefacEnum.RESTAURANTE, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,"comanda"),
    ...
    REPORTE_MANTENIMIENTO("ec.com.codesoft.codefaclite.facturacion.model.ProformaModel", "REMA", "Reporte Mantenimiento", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,"reporte_mantenimiento"),
