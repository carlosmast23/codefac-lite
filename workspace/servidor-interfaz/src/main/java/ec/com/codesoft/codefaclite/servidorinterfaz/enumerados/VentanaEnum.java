...
public enum VentanaEnum {
    ...
    REPORTE_DEUDASGRUPO("ec.com.codesoft.codefaclite.gestionacademica.model.ReporteDeudasGrupoModel","RDEG","",ModuloCodefacEnum.GESTIONA_ACADEMICA,CategoriaMenuEnum.REPORTES),
