...
public enum VentanaEnum implements Serializable{
    ...
    COMPRA_REPORTE_PRODUCTO("ec.com.codesoft.codefaclite.compra.model.CompraReporteProductoModel", "CRPM", "Listado de Precio por Proveedor", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.REPORTES,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,null),
    ...
    VARIANTE("ec.com.codesoft.codefaclite.inventario.model.VarianteModel", "VARI", "Variante", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.GESTIONAR,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,null),
    PRESENTACION_PRODUCTO("ec.com.codesoft.codefaclite.inventario.model.PresentacionProductoModel", "PPMO", "Presentacion", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.GESTIONAR,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,null),
    CASA_COMERCIAL("ec.com.codesoft.codefaclite.inventario.model.CasaComercialModel", "CSCL", "Casa Comercial", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.GESTIONAR,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,null),
    ...
    KARDEX("ec.com.codesoft.codefaclite.inventario.model.KardexModel", "KARD", "Kardex", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.REPORTES,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.GRATIS,KeyEvent.VK_K,null),
    ...
    CATALOGO_PRODUCTO("ec.com.codesoft.codefaclite.inventario.model.CatalogoProductoModel", "CAPR", "Catalogo Producto", ModuloCodefacEnum.FACTURACION, CategoriaMenuEnum.GESTIONAR,TipoLicenciaEnum.GRATIS,null),
    ...
    RETENCIONES("ec.com.codesoft.codefaclite.compra.model.RetencionModel", "RETC", "Retención", ModuloCodefacEnum.COMPRA, CategoriaMenuEnum.PROCESOS,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,KeyEvent.VK_R,null),
    ...
    ABONO("ec.com.codesoft.codefaclite.cartera.model.AbonoModel", "ABON", "Abono", ModuloCodefacEnum.CARTERA, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,"abono"),
    ...
    OBJETO_MANTENIMIENTO("ec.com.codesoft.codefaclite.servicios.model.ObjetoMantenimientoModel", "OBMA", "Objeto Mantenimiento", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.GESTIONAR,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.SERVICIOS},TipoLicenciaEnum.PRO,null,null),
    TAREAS_PENDIENTE_OT("ec.com.codesoft.codefaclite.servicios.model.TareaPendienteOrdenTrabajoModel", "TPOT", "Tareas Pendientes OT", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.GESTIONAR,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.SERVICIOS},TipoLicenciaEnum.PRO,null,null),
    PRESUPUESTO_REPORTE("ec.com.codesoft.codefaclite.servicios.model.ReportePresupuestosModel", "PRER", "Presupuesto Reporte", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.REPORTES,null),
    ACTIVIDADES_REPORTE("ec.com.codesoft.codefaclite.servicios.model.ReporteActividadesPresupuestoModel", "RAPM", "Actividades Presupuesto Reporte", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.REPORTES,null),
    ...
    GUIA_REMISION_LOTE("ec.com.codesoft.codefaclite.transporte.model.GuiaRemisionLoteModel", "GRML", "Guía Remisión Lote", ModuloCodefacEnum.TRANSPORTE, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,null),
    GUIA_REMISION("ec.com.codesoft.codefaclite.transporte.model.GuiaRemisionModel", "GURE", "Guía de Remisión", ModuloCodefacEnum.TRANSPORTE, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,KeyEvent.VK_M,"guia_remision"),
    ...
    DETALLE_REMBOLSO("ec.com.codesoft.codefaclite.facturacion.model.DetalleReembolsoModel", "DERM", "Detalle Reembolso", ModuloCodefacEnum.FACTURACION, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.GRATIS,null,null),
    COMANDA("ec.com.codesoft.codefaclite.facturacion.model.ComandaModel", "COMD", "Comanda", ModuloCodefacEnum.RESTAURANTE, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,"comanda"),
    COMANDA_MONITOR("ec.com.codesoft.codefaclite.facturacion.model.ProformaModel", "COMR", "Comanda Monitor", ModuloCodefacEnum.RESTAURANTE, CategoriaMenuEnum.REPORTES,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,"comanda_monitor"),
    ...
    STOCK_REPORTE("ec.com.codesoft.codefaclite.inventario.model.StockReporteModel", "STRE", "Stock reporte", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.REPORTES,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.GRATIS,null,"reporte_inventario_stock"),
    STOCK_CONSULTA_RAPIDA("ec.com.codesoft.codefaclite.inventario.model.StockConsultaRapidaModel", "SCRA", "Stock Consulta Rapida", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.REPORTES,true,new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.GRATIS,null,null),
    ...
    ARQUEO_CAJA("ec.com.codesoft.codefaclite.pos.model.ArqueoCajaModel", "AQCJ", "Arqueo Caja", ModuloCodefacEnum.POS, CategoriaMenuEnum.PROCESOS, TipoLicenciaEnum.PRO, null),
    ...
    MANTENIMIENTOS_PENDIENTES("ec.com.codesoft.codefaclite.facturacion.model.ProformaModel", "MAPE", "Unidades Taller", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,"mantenimientos_pendientes"),
    TAREA_MANTENIMIENTO("ec.com.codesoft.codefaclite.facturacion.model.ProformaModel", "TAMA", "Tareas Operarios", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,"tarea_mantenimiento"),
