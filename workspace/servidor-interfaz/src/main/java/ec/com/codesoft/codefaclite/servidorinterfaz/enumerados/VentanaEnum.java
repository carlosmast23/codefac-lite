...
public enum VentanaEnum implements Serializable{
    ...
    BODEGA("ec.com.codesoft.codefaclite.inventario.model.BodegaModel", "BODG", "Bodega", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.GESTIONAR,TipoLicenciaEnum.GRATIS,null),
    CATEGORIA_PRODUCTO("ec.com.codesoft.codefaclite.inventario.model.CategoriaProductoModel", "CATG", "Categoria", ModuloCodefacEnum.CRM, CategoriaMenuEnum.GESTIONAR,TipoLicenciaEnum.GRATIS,null),
    ...
    KARDEX("ec.com.codesoft.codefaclite.inventario.model.KardexModel", "KARD", "Kardex", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.REPORTES,TipoLicenciaEnum.GRATIS,null),
    ...
    GESTION_INVENTARIO("ec.com.codesoft.codefaclite.inventario.model.GestionInventarioModel", "GIMO", "Gestión Inventario", ModuloCodefacEnum.INVENTARIO, CategoriaMenuEnum.PROCESOS,TipoLicenciaEnum.GRATIS,null),
