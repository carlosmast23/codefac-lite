...
public enum VentanaEnum implements Serializable{
    ...
    PRESUPUESTO_REPORTE("ec.com.codesoft.codefaclite.servicios.model.PresupuestoModel", "PRES", "Presupuesto Reporte", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.REPORTES,null),
