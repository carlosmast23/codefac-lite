...
public enum VentanaEnum implements Serializable{
    ...
    MANTENIMIENTOS_PENDIENTES("ec.com.codesoft.codefaclite.facturacion.model.ProformaModel", "MAPE", "Pendientes Taller", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,"mantenimientos_pendientes"),
