...
public enum VentanaEnum implements Serializable{
    ...
    REPORTE_MANTENIMIENTO("ec.com.codesoft.codefaclite.facturacion.model.ProformaModel", "REMA", "Reporte", ModuloCodefacEnum.SERVICIOS, CategoriaMenuEnum.PROCESOS,true, new ModuloCodefacEnum[]{ModuloCodefacEnum.FACTURACION},TipoLicenciaEnum.PRO,null,"reporte_mantenimiento"),
